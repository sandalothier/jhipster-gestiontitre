package com.fisc.gestiontitre.web.rest;

import com.fisc.gestiontitre.GestiontitreApp;
...
@SpringBootTest(classes = GestiontitreApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class GestiontitreKafkaResourceIT {
    ...
    @Autowired
    private GestiontitreKafkaProducer producer;

    @Autowired
    private GestiontitreKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        GestiontitreKafkaResource kafkaResource = new GestiontitreKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/gestiontitre-kafka/publish?message=test"))
